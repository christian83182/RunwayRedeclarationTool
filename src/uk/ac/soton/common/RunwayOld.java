...
public class RunwayOld extends PositionalObject{
    ...
    private RunwayOld opposite = null;

    private Obstacle obstacle = null; // no obstacle present initially

    public RunwayOld(String id, Integer xPos, Integer yPos, Integer length, Integer width){
        super(xPos, yPos, id);
        this.length = length;
        this.width = width;
        this.toda = length;
    ...
    public void placeObstacle(String id, Integer thresholdDistance, Integer centrelineDistance, Integer runwayDistance,
        ...
        Integer yPos = this.getyPos() + centrelineDistance + (int) Math.round(dimensions.getWidth());
